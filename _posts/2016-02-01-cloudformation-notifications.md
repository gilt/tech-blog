...
1. If you - like me - prefers to switch to something else while the deployment is ongoing, you would probably want to be notified when the deployment is finished; i.e., "don't call me, I'll call you"-sort of thing. The email notifications were a good fit for that;
