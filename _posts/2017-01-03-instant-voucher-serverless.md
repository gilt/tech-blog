...
Since many of Gilt City’s offers are of impulsive nature and time-sensitive, long processing time becomes a clear bottleneck to user experience and feature development. Team Marconi in Gilt have been driving the work on Instant Vouchers Initiative since a few months ago, in an effort to re-architect the backend of order processing with latest cloud technologies. We believe that by reducing this wait time, it will significantly boost overall shopping experience. Imagine that if users can receive their voucher immediately after placing an order, they are more likely to use it sooner after.
